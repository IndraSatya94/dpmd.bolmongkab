            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="button-buat animate__animated animate__bounceInDown">
                        <a class="btn btn-primary" href="{{ route('beritas.create') }}"><i class="fas fa-plus"></i>
                            Tambah</a>
                    </div>
                            ...
                            <table class="table table-bordered animate__animated animate__bounceInRight animate__fast">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{ $berita->konten }}</td>
                                        <td><img src="/image/berita/{{ $berita->image }}" width="100px"></td>
                                        <td>{{ $berita->slug }}</td>
                                        <td>
                                            <form action="{{ route('beritas.destroy',$berita->id) }}" method="POST"
                                                ...
                                                <a class="btn btn-info"
                                                    href="{{ route('beritas.show',$berita->id) }}">Show</a>

                                                <a class="btn btn-warning"
                                                    href="{{ route('beritas.edit',$berita->id) }}"><i
