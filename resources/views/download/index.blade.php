        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid animate__animated animate__bounceInDown">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Halaman Download</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="button-buat animate__animated animate__bounceInDown">
                        <a class="btn btn-primary" href="{{ route('download.create') }}"><i class="fas fa-plus"></i>
                            Tambah</a>
                    </div>
                    ...
                    <div class="card text-center card-primary" style="margin-top:10px;">
                        ...
                        <div class="card-body">
                                        ...
                                        <td>
                                            <form action="{{ route('download.destroy',$down->id) }}" method="POST"
                                                ...
                                                <a class="btn btn-warning"
                                                    href="{{ route('download.edit',$down->id) }}"><i
                            ...
                            <div class="pagination" style="margin-top:20px;">
                                {!! $download->links('Template.pagination') !!}
                            </div>
                        </div>
                    </div>
