        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid animate__animated animate__bounceInDown">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Halaman Slide</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="button-buat animate__animated animate__bounceInDown">
                        <a class="btn btn-primary" href="{{ route('slide.create') }}"><i class="fas fa-plus"></i>
                            Tambah</a>
                    </div>
                    ...
                    <div class="card text-center card-primary" style="margin-top:10px;">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-responsive animate__animated animate__bounceInRight animate__fast">
                                ...
                                <tbody>
                                    <tr>
                                        <td>{{ ++$i }}</td>
                                        <td>{{ $sli->slide }}</td>
                                        <td><img src="/image/slide/{{ $sli->image }}" width="100px"></td>
                                        <td>{{ $sli->caption }}</td>
                                        <td>{{ $sli->body }}</td>
                                        <td>
                                            <form action="{{ route('slide.destroy',$sli->id) }}" method="POST"
                                                ...
                                                <a class="btn btn-warning" href="{{ route('slide.edit',$sli->id) }}"><i
                            ...
                            <div class="pagination" style="margin-top:20px;">
                                {!! $slide->links('Template.pagination') !!}
                            </div>
                        </div>
                    </div>
