        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div class="card card-primary" style="margin-top:10px;">
                    ...
                    <div class="card-body">
                        <form action="{{ route('galeris.update',$galeri->id) }}" method="POST"
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Nama:</strong>
                                    <input type="text" name="nama" value="{{ $galeri->nama }}" class="form-control"
                                        placeholder="nama">
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="custom-select" id="inputGroupSelect01" name="jenis_file"
                                            id="jenis_file">
                                            <option selected="{{ $galeri->jenis_file }}">{{$galeri->jenis_file}}</option>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <img src="/file/galeri/{{ $galeri->file }}" width="300px" style="padding-top:20px;">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                                <button type="submit" class="btn btn-primary"
                                    onClick="return confirm('Ubah Data ?')">Submit</button>
                                <a class="btn btn-light" href="{{ route('galeris.index') }}">Cancel</a>
                            </div>
