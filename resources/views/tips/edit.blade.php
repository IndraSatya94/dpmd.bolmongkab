                        ...
                        <form action="{{ route('tips.update',$tip->id) }}" method="POST"
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="judul_tips" value="{{ $tip->judul_tips }}" class="form-control"
                                        placeholder="judul_tips">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" style="height:150px" name="body"
                                        placeholder="Body">{{ $tip->body }}</textarea>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <img src="/image/tips/{{ $tip->image }}" width="300px" style="padding-top:20px;">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                                <button type="submit" class="btn btn-primary"
                                    onClick="return confirm('Ubah Data ?')">Submit</button>
                                <a class="btn btn-light" href="{{ route('tips.index') }}">Cancel</a>
                            </div>
