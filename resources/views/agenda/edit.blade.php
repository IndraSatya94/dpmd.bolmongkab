                        ...
                        <div class="card-body">
                            <form action="{{ route('agenda.update',$agenda->id) }}" method="POST"
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>acara:</strong>
                                        <textarea class="form-control" style="height:150px" name="acara"
                                            placeholder="Acara">{{ $agenda->acara }}</textarea>
                                    </div>
                                </div>
                                <div class="col-xs-4 col-sm-4 col-md-4">
                                    <div class="form-group">
                                        <strong>Tempat:</strong>
                                        <input type="text" name="tempat" value="{{ $agenda->tempat }}"
                                ...
                                <div class="col-xs-4 col-sm-4 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tanggal" value="{{ $agenda->tanggal }}"
                                ...
                                <div class="col-xs-4 col-sm-4 col-md-4">
                                    <div class="form-group">
                                        <strong>Mulai:</strong>
                                        <input type="time" name="mulai" value="{{ $agenda->mulai }}"
                                ...
                                <div class="col-xs-4 col-sm-4 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="time" name="selesai" value="{{ $agenda->selesai }}"
