...
<body class="hold-transition register-page">
    <div class="register-box">
        <div class="register-logo">
            <a href="{{ url('/') }}"><b>Operator Website</b></a>
        </div>

        <div class="card">
            <div class="card-body register-card-body">
                <p class="login-box-msg">Daftarkan Operator Baru</p>
...
<!-- 
                ...
                <form action="{{ route('simpanregistrasi') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-4">
                            <button type="submit" class="btn btn-primary btn-block"  onClick="return confirm('Simpan ?')">Register</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
