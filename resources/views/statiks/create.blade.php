                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="custom-select" id="inputGroupSelect01" name="halaman"
                                            ...
                                            <option value="usaha">Bina Usaha Ekonomi Desa</option>
                                            <option value="pemerintahan">Bina Pemerintahan Desa dan Pengembangan Desa</option>
                                            <option value="kelembagaan">Bina Kelembagaan dan Pemanfaatan TTG</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
